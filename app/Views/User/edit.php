    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card-body">
                ...
                <?php endif; ?>
                <form id="form-submit" action="/user/update/<?= $result['id']; ?>" method="post" enctype="multipart/form-data">
                    <?= csrf_field(); ?>
                    ...
                    <div class="form-group row">
                        <label for="role" class="col-sm-2 col-form-label">Username <span class="text-danger font-weight-bold">*</span></label>
                        <div class="col-sm-10">
